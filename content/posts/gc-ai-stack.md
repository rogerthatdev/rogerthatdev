...
| :---- | :---- | :---- | :---- |
| Infrastructure | Coming soon | Google Compute Engine (GCE) | [Create a Deep Learning VM instance via Cloud Console](https://docs.cloud.google.com/deep-learning-vm/docs/create-vm-instance-console) |
|  |  | Google Kubernetes Engine (GKE) | [Introduction to AI/ML workloads on GKE](https://docs.cloud.google.com/compute/docs/accelerator-optimized-machines) |
| Model | Coming soon | Vertex AI | [Overview of Model Garden](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/model-garden/explore-models) |
| Data | Coming soon | AlloyDB | [What is AlloyDB AI?](https://docs.cloud.google.com/alloydb/docs/ai/what-is-alloydb-ai) |
|  |  | Big Query | [Introduction to AI in BigQuery](https://docs.cloud.google.com/bigquery/docs/ai-introduction) |
